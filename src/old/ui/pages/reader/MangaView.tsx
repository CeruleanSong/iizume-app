...
import StyledStaticFlatListItem from '../../components/StyledStaticFlatListItem';
	...
	return (
		<View>
			...
			<FlatList
				...
				renderItem={({ item, index }: any) => <StyledStaticFlatListItem key={index} title={item.title} onSelect={() => null} /> }
